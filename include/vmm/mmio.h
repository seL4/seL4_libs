...
typedef void (*vmm_mmio_read_fn)(void *cookie, uint32_t rel_addr, int size, uint32_t *result);
typedef void (*vmm_mmio_write_fn)(void *cookie, uint32_t rel_addr, int size, uint32_t value);
